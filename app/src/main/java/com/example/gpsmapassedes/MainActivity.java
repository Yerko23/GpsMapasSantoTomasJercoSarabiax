...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ImageButton imageButton = findViewById(R.id.Video_Play);  // Reemplaza "miImageButton" con el ID de tu ImageButton
...
// Asigna un evento onClick al ImageButton
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, Video_st.class);
